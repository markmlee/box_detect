...
int minH = 0, maxH = 26, minS = 60, maxS = 255, minV = 58, maxV = 216;
...
#define contourAreaThreshold 10000
...
/* Create tf broadcaster for camera to base link*/
    static tf::TransformBroadcaster broadcaster;
    	broadcaster.sendTransform( tf::StampedTransform( /*90+10deg pitch camera (30 but offset)*/
         tf::Transform(tf::createQuaternionFromRPY(100*3.14/180, 0, 90*3.14/180), tf::Vector3(0.0, 0.0, 1.25)),
